 ...
 *   - packaging excludes
 *   - lint configuration
 *   - Java toolchain 24, Kotlin jvmToolchain(24)
...
class AndroidLibraryConventionPluginTest {
    ...
    fun appliesPlugin_andListsTasks() {
        ...
        assertTrue(output.contains("cleanGeneratedSources"), "Expected cleanGeneratedSources task to be registered.")
    }
    ...
    fun preBuildDependsOn_cleanGeneratedSources() {
        ...
        assertTrue(output.contains("preBuild"), "Expected preBuild task to exist when com.android.library is applied.")
        assertTrue(
    ...
    fun configuresJavaAndKotlinToolchains() {
        ...
        assertTrue(output.contains("java.sourceCompatibility=VERSION_24"), "Expected Java sourceCompatibility 24.\n$output")
        assertTrue(output.contains("java.targetCompatibility=VERSION_24"), "Expected Java targetCompatibility 24.\n$output")
        assertTrue(output.contains("kotlin.jvmToolchain.configured=YES"), "Expected Kotlin jvmToolchain to be configured.\n$output")
    }
    ...
    private fun discoverPluginIdOrDefault(): String {
        ...
        return try {
            val res = javaClass.classLoader.getResourceAsStream("META-INF/gradle-plugins/") // directory listing not available
