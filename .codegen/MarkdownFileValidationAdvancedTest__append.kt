// -------------------------------------------------------------------------
    ...
    inner class SlugNormalizationAdditionalCases {
        ...
        /**
         * Converts a Markdown header text into a URL/anchor-friendly slug.
         *
         * Leading Markdown header markers (e.g., `#`) are removed and emoji/symbol characters are stripped.
         * The result is lowercased, non-alphanumeric characters (except spaces and hyphens) are removed,
         * runs of whitespace are replaced with single hyphens, consecutive hyphens are collapsed,
